...
import com.affinistechnologies.jamrocksingles.jamrocksingles.activities.EditOrCreateProfileActivity;
...
public class ProfileFragment extends Fragment implements FloatingActionButton.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        btnEditProfile = (FloatingActionButton)view.findViewById(R.id.btnEditProfile);
    ...
    {
        Intent i = new Intent(this.getContext(), EditOrCreateProfileActivity.class);
        startActivity(i);
    }
    /**
